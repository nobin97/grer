...
try:
    ...
    while True:
        ...
        while(cnt < 5):
            ...
            if os.path.exists('./Subject_images') == False:
                os.mkdir('./Subject_images')
            path = "./Subject_images/subject_img_.jpg"
            cv2.imwrite(path, frame)
            print(cnt + 1, ". Captured ", path, sep = "")
            cnt += 1
            try:
                #imagePath = "./Subject_images/subject_img_.jpg"
                ...
                try:
                    print("Detected Emotion:", emotion_text, end = "\n\n")
        ...
        if emotion_array == []:
            ...
            print("\nEmotion count too low to deduce the most probable emotion...\nRestarting...")
            continue
        #print("\n",emotion_array, sep="")
